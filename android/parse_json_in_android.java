...
// this class extends ListActivity to show the data in every item
public class NetworkingAndroidHttpClientJSONActivity extends ListActivity {
	...
	private class HttpGetTask extends AsyncTask<Void, Void, List<String>> { // this means the result is a List for contain string
		...
		protected void onPostExecute(List<String> result) {
            ...
            // set List Adapter, and the result is a List<String>
